        ...
        try:
            ...
            for host in HostList:
                ...
                try:
                    ...
                    print '======================×ÓÈÎÎñÐ´Èëmysql====================='
                    try:
                        WriteToEtcd(host,hostdic)
                        print '======================×ÓÈÎÎñÒÑÐ´Èëetcd====================='
                    except Exception,error:
                        print '======================Ð´ÈëetcdÊ§°Ü %s=====================' % error
                except Exception,error:
                    print "==============×ÓÈÎÎñÉú³ÉÊ§°Ü %s===================" % error
        except Exception,error:
...
#                         print '======================å­ä»»åŠ¡å·²ç”Ÿæˆ====================='
#                     except Exception,error:
#                         print "==============å­ä»»åŠ¡ç”Ÿæˆå¤±è´¥ %s===================" % error
#                 else:
...
#             return  render(request,'basex.html',{'sdf':e})
#     return render(request,'basex.html',{'sdf':dicx})
>>>>>>> 0ad38c48428e7d10c83df9c3bd31140474f67a82
